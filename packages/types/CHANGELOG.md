...
- a004d24: Add three-tier plugin auto-discovery to `stackwright-prebuild` so Pro content types (`data_table_pulse`, `metric_card_pulse`, etc.) validate correctly during prebuild — matching the fidelity of `next dev` runtime.

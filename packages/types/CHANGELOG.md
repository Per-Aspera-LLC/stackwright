...
- 4e10537: Sync site-config JSON schema with websocket and SSE TypeScript type additions
- Updated dependencies [4e10537]
- Updated dependencies [4e10537]
  - @stackwright/themes@0.7.0
...
- 97da06f: Sync site-config JSON schema with websocket and SSE TypeScript type additions
- Updated dependencies [97da06f]
- Updated dependencies [97da06f]
  - @stackwright/themes@0.8.0
...
- Updated dependencies [98bc1f7]
  - @stackwright/themes@0.7.0-alpha.0
...
- 5e6d487: Sync site-config JSON schema with websocket and SSE TypeScript type additions
- Updated dependencies [5e6d487]
  - @stackwright/themes@0.6.1
...
- Updated dependencies [adb13ae]
  - @stackwright/themes@0.5.3-alpha.1
...
- 8616cd5: fix(types): remove zod internals from PrebuildPlugin public interface
...
- 8616cd5: Export `ZodLike` from `@stackwright/types` so plugin authors can reference it by name without index-access workarounds. Also widens `ZodLike.issues[].path` from `(string | number)[]` to `PropertyKey[]` to match Zod v4's actual `$ZodIssue.path` type, fixing a nominal TypeScript incompatibility where real Zod schemas did not satisfy `ZodLike` at the type level.
...
- 265bf87: Add `contentItemSchemas` and `knownContentTypeKeys` to `PrebuildPlugin` interface.
...
- b14b0d2: feat: add integrations config to site schema
...
- ec21b1f: feat: add integrations config to site schema

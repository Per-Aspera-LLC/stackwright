...
- 174b3bf: feat(cli): replace scaffold builder functions with Zod schema introspection + GitHub template repo
...
- ac3a634: Add ESM output to CLI package to fix Vite/Vitest module resolution in downstream packages
...
- Updated dependencies [c2f7867]
  ...
  - @stackwright/build-scripts@0.3.0

...
- 083f3b1: **fix(build-scripts): dedup plugin-declared type warnings + thread prebuild.unknownContentTypes from yml**
...
- 699b204: Add structured NDJSON prebuild telemetry sink (swp-6xr3.1, child of swp-6xr3).

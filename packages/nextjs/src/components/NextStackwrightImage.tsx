...
export const NextStackwrightImage: React.FC<StackwrightImageProps> = ({
  ...
  if(process.env.NODE_ENV == 'development' && process.env.STACKWRIGHT_DEBUG == 'true') console.log('📸 NextStackwrightImage Debug: Image props:', imageProps);
  
  try {
    const ImageComponent = (typeof Image === 'object' && 'default' in Image) 

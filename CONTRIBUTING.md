...
1. Run `pnpm stackwright -- generate-agent-docs` to regenerate AGENTS.md tables in both `/AGENTS.md` and `examples/stackwright-docs/AGENTS.md`, and `pnpm stackwright -- generate-skills` to regenerate `skills/stackwright-page-authoring/SKILL.md` (CI runs `generate-skills --check` and fails on drift)

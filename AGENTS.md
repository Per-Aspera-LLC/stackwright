...
**AGENTS: This pointer is auto-generated from the live Zod schemas. The full reference lives in the `stackwright-page-authoring` skill. Run `pnpm stackwright -- generate-agent-docs` to regenerate. Do NOT edit the content between the markers manually.**
